...
public class Constant {
  ...
  public static final String AUTHOR_ID = "Author's Id";
  public static final String AUTHOR_ID_ENTER = "Enter author's Id";
  public static final String AUTHOR_NAME_ENTER = "Enter author's name";
