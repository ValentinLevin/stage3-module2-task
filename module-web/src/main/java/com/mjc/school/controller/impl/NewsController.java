...
public class NewsController implements BaseController<NewsRequestDTO, NewsDTO, Long> {
    private final BaseService<AuthorRequestDTO, AuthorDTO, Long> authorService;

    public NewsController(BaseService<AuthorRequestDTO, AuthorDTO, Long> authorService) {
